package  {
	...
	public class Platform extends MovieClip {
		...
		{
			//if it hits left
			if (this.hitTestObject(Game.hero) && Game.hero.x + Game.hero.width >= this.x )
			{
				Game.hero.x = this.x - Game.hero.width;
			}
			//if it hits right
			if (this.hitTestObject(Game.hero) && Game.hero.x <= this.x + this.width)
			{
				Game.hero.x = this.x + this.width;
			}
			//if it hits above
			if (this.hitTestObject(Game.hero) && Game.hero.y + Game.hero.height >= this.y )
			{
